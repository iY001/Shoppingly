    ...
    return (
        <>
            <div className='z-0 md:relative container md:w-[70%] w-full md:mx-auto rounded-2xl mt-14 md:bg-[#E8F9FD] py-8 md:py-0 flex items-center md:justify-normal flex-col md:flex-row'>
                ...
                <section className='lg:basis-1/4 w-full'>
                ...
                <section className='lg:block md:hidden block w-full md:absolute md:top-0 md:right-0 md:mt-[-40px] md:mr-[-20px] md:w-48 md:h-48 bg-[#FFF] md:rounded-full text-[#F43A09] text-3xl font-bold text-center'>
                    <h1 className='md:mt-14 mt-4 md:text-5xl'>UP TO <p className='md:text-[#F43A09] text-white bg-[#F43A09] md:bg-transparent md:py-0 md:mt-0 py-6 mt-4 text-center w-full'>70%</p></h1>
                </section>
            </div> {/* Main Container */}
        </>
    )
