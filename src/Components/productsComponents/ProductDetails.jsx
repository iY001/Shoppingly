...
function ProductDetails() {
  ...
  return (
    <>
      ...
      <div className='relative bg-gray-200 w-full flex md:flex-row-reverse flex-col justify-between  px-10 py-12'>
        ...
        <section className='md:w-[50%] py-24 text-[#f43c09a7]'>
          <h1 className='font-semibold text-4xl my-2 '>Product Name</h1>
          ...
          <p className='font-semibold text-3xl my-4'>300$</p>
          <p className='text-2xl text-black'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Praesentium, autem! Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt, natus?</p>
